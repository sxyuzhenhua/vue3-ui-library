...
.demo-icon {
  ...
  &-list {
    ...
    list-style: none;
    padding: 0 !important;
    border-top: 1px solid var(--yu-border-color);
    border-left: 1px solid var(--yu-border-color);
    border-radius: 4px;
    display: grid;
    ...
    .icon-item {
      ...
      height: 90px;
      font-size: 13px;
      border-right: 1px solid var(--yu-border-color);
      border-bottom: 1px solid var(--yu-border-color);
      transition: background-color var(--yu-transition-duration);
      &:hover {
        background-color: var(--yu-border-color-extra-light);
        .yu-icon {

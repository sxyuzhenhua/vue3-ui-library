<template>
  <yu-roving-focus-collection-item
    :id="id"
    :focusable="focusable"
    :active="active"
  >
...
import { useId } from "@yu/hooks";
import { composeEventHandlers } from "@yu/utils";
import { EVENT_CODE } from "@yu/constants";
import {
  ROVING_FOCUS_COLLECTION_INJECTION_KEY,
  YuCollectionItem as YuRovingFocusCollectionItem,

...
import { CHANGE_EVENT, EVENT_CODE, UPDATE_MODEL_EVENT } from "@yu/constants";
import {
  debugWarn,
  getComponentSize,
  isFunction,
...
import type ElTooltip from "@yu/components/tooltip";
  ...
  useDeprecated(
    {
      ...
      version: "2.3.0",
      scope: "props",
      ref: "https://yu.org/en-US/component/select.html#select-attributes",
    },

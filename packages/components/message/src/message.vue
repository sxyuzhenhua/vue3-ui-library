  ...
  >
    ...
    >
      <yu-badge
        ...
        :class="ns.e('badge')"
      />
      <yu-icon v-if="iconComponent" :class="[ns.e('icon'), typeClass]">
      ...
      <yu-icon v-if="showClose" :class="ns.e('closeBtn')" @click.stop="close">
        <Close />
      </yu-icon>
    </div>
  </transition>
...
import { TypeComponents, TypeComponentsMap } from "@yu/utils";
...
import type { BadgeProps } from "@yu/components/badge";
